 ...
 */
public class Test_FrontConsume extends DemoBase {

	public String forwardPay() {
		...
		// 前台通知地址 ，控件接入方式无作用
		data.put("frontUrl", "http://123.57.60.214/iviservice/frontnotice");
		// 后台通知地址
		data.put("backUrl", "http://123.57.60.214/iviservice/backnotice");
		// 接入类型，商户接入填0 0- 商户 ， 1： 收单， 2：平台商户
		data.put("accessType", "0");
		// 商户号码，请改成自己的商户号
		data.put("merId", "777290058112416");//商户号已修改
		// 商户订单号，8-40位数字字母

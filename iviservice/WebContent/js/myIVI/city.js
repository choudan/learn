...
var addressSelector = function(province,city,district){   
            ...
            var data = this.data; 
            		/*为第一级列表添加元素*/
            if(province.length <2){              //就是说province还没有被初始化
                    for(var i in data){           //那就遍历地域的json串
                    if(data[i][1] == "1"){        //在data里找到第一级数据
                       var oOption = document.createElement("option");   //创建了一个option元素
                           oOption.text=data[i][0];        //添加内容  
                           oOption.value=i;				   //添加value
                           oOption.id=i;
                           province.add(oOption);          //添加到节点
        ...
        addressSelector.prototype.changeAction = function(elem,data,changeThis){
            var thisVal = changeThis.value;        	  //获取自变量地区代码
            elem.innerHTML = "";					  //先把因变量置空

            for(var i in data){                       //循环获取上级文本为thisVal的
                 if(thisVal == data[i][1]){                	 
        ...
        addressSelector.prototype.data = {
            ...
            "110229": ["\u5ef6\u5e86\u53bf", "110100"],
            "110230": ["\u5176\u5b83\u533a", "110100"],
            "120000": ["\u5929\u6d25", "1"],          //第一项是地域名称，第二项是所属父选项框
            "120100": ["\u5929\u6d25\u5e02", "120000"],
            "120101": ["\u548c\u5e73\u533a", "120100"],
            "120102": ["\u6cb3\u4e1c\u533a", "120100"],
            "120103": ["\u6cb3\u897f\u533a", "120100"],

...
public class JavaMail {
    ...
    public JavaMail(boolean debug) {
        InputStream in = JavaMail.class.getResourceAsStream("/a_little_config.txt");
        try {
            properties.load(in);
            this.mailHost = properties.getProperty("mail.smtp.host");
            System.out.println("quzhi"+this.mailHost);
            this.sender_username = properties.getProperty("mail.sender.username");
            this.sender_password = properties.getProperty("mail.sender.password");
        } catch (IOException e) {
        	System.out.println("quzhi");
            e.printStackTrace();
        }
    ...
    public void doSendHtmlEmail(String subject, String sendHtml,
        ...
        try {
            ...
            InternetAddress from = new InternetAddress(MimeUtility.encodeWord("IVI用户")+" <"+sender_username+">");
	...
	public void sdMail(String contents) {
		JavaMail se = new JavaMail(false);
//		se.doSendHtmlEmail("邮件主题:客户申请安装信息", contents, "1723349178@qq.com");
		se.doSendHtmlEmail("邮件主题:客户申请安装信息", contents, "sales@tyjbj.cn");
		System.out.println("发送咯");
	}
//    public static void main(String[] args) {
//    	JavaMail se = new JavaMail(false);
//    	se.doSendHtmlEmail("邮件主题:客户申请安装信息", "你好", "1723349178@qq.com");
//    }
}
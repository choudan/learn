...
/**
 * 
 * @author choudan 自定义布局解决键盘弹出挡住输入框的问题
 */
public class ChatView extends RelativeLayout {
	...
	public ChatView(Context paramContext, AttributeSet paramAttributeSet) {
	...
	public void setOnSizeChangedListenner(
			ChatView.OnSizeChangedListenner paramonSizeChangedListenner) {

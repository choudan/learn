 ...
 * 
 */
public class IqueryDocExpAdapter extends BaseAdapter {
	
	public Context mContext;
	public ArrayList<MsaBound> list;
	public IqueryDocExpAdapter(Context mContext, ArrayList<MsaBound> list) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		viewHolder.price.setText(""+list.get(position).getHospital()+list.get(position).getDept());
		return convertView;
	}

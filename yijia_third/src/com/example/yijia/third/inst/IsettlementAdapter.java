 ...
 * 
 */
public class IsettlementAdapter extends BaseAdapter {
	
	public Context mContext;
	public ArrayList<SettlementInst> list;
	public IsettlementAdapter(Context mContext, ArrayList<SettlementInst> list) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		viewHolder.service_name.setText(list.get(position).getInstName());

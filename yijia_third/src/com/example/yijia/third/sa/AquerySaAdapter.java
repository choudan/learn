 ...
 * 
 */
public class AquerySaAdapter extends BaseAdapter {
	
	public Context mContext;
	public ArrayList<Sa> list;
	public AquerySaAdapter(Context mContext, ArrayList<Sa> list) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		viewHolder.price.setText("当前用户数："+list.get(position).getPresentNum());
		return convertView;
	}
